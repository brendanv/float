...
> **IMPORTANT (float project):** All shadcn components live in `web/`. Always `cd web` before running any `shadcn` CLI commands, and resolve all component paths relative to `web/` (e.g. `web/src/components/ui/`).

## Current Project Context

```json
!`cd web && npx shadcn@latest info --json`
```
