...
const file_float_v1_ledger_proto_rawDesc = "" +
	...
	"\rapplied_count\x18\x01 \x01(\x05R\fappliedCount2\x8c\x1a\n" +
	"\rLedgerService\x12Y\n" +
...
var file_float_v1_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 106)
var file_float_v1_ledger_proto_goTypes = []any{
	...
	(*BackfillPricesRequest)(nil),            // 42: float.v1.BackfillPricesRequest
	(*BackfillPricesResponse)(nil),           // 43: float.v1.BackfillPricesResponse
	(*AccountDeclaration)(nil),               // 44: float.v1.AccountDeclaration
	(*ListAccountDeclarationsRequest)(nil),   // 45: float.v1.ListAccountDeclarationsRequest
	(*ListAccountDeclarationsResponse)(nil),  // 46: float.v1.ListAccountDeclarationsResponse
	(*DeclareAccountRequest)(nil),            // 47: float.v1.DeclareAccountRequest
	(*DeclareAccountResponse)(nil),           // 48: float.v1.DeclareAccountResponse
	(*DeleteAccountDeclarationRequest)(nil),  // 49: float.v1.DeleteAccountDeclarationRequest
	(*DeleteAccountDeclarationResponse)(nil), // 50: float.v1.DeleteAccountDeclarationResponse
	(*MarkReviewedOperation)(nil),            // 51: float.v1.MarkReviewedOperation
	(*AddTagOperation)(nil),                  // 52: float.v1.AddTagOperation
	(*RemoveTagOperation)(nil),               // 53: float.v1.RemoveTagOperation
	(*SetPayeeOperation)(nil),                // 54: float.v1.SetPayeeOperation
	(*ClearPayeeOperation)(nil),              // 55: float.v1.ClearPayeeOperation
	(*BulkEditOperation)(nil),                // 56: float.v1.BulkEditOperation
	(*BulkEditTransactionsRequest)(nil),      // 57: float.v1.BulkEditTransactionsRequest
	(*BulkEditTransactionsResponse)(nil),     // 58: float.v1.BulkEditTransactionsResponse
	(*Snapshot)(nil),                         // 59: float.v1.Snapshot
	(*ListSnapshotsRequest)(nil),             // 60: float.v1.ListSnapshotsRequest
	(*ListSnapshotsResponse)(nil),            // 61: float.v1.ListSnapshotsResponse
	(*RestoreSnapshotRequest)(nil),           // 62: float.v1.RestoreSnapshotRequest
	(*RestoreSnapshotResponse)(nil),          // 63: float.v1.RestoreSnapshotResponse
	(*BankProfile)(nil),                      // 64: float.v1.BankProfile
	(*ListBankProfilesRequest)(nil),          // 65: float.v1.ListBankProfilesRequest
	(*ListBankProfilesResponse)(nil),         // 66: float.v1.ListBankProfilesResponse
	(*CreateBankProfileRequest)(nil),         // 67: float.v1.CreateBankProfileRequest
	(*CreateBankProfileResponse)(nil),        // 68: float.v1.CreateBankProfileResponse
	(*GetBankProfileContentRequest)(nil),     // 69: float.v1.GetBankProfileContentRequest
	(*GetBankProfileContentResponse)(nil),    // 70: float.v1.GetBankProfileContentResponse
	(*UpdateBankProfileRequest)(nil),         // 71: float.v1.UpdateBankProfileRequest
	(*UpdateBankProfileResponse)(nil),        // 72: float.v1.UpdateBankProfileResponse
	(*DeleteBankProfileRequest)(nil),         // 73: float.v1.DeleteBankProfileRequest
	(*DeleteBankProfileResponse)(nil),        // 74: float.v1.DeleteBankProfileResponse
	(*PreviewImportRequest)(nil),             // 75: float.v1.PreviewImportRequest
	(*ImportCandidate)(nil),                  // 76: float.v1.ImportCandidate
	(*PreviewImportResponse)(nil),            // 77: float.v1.PreviewImportResponse
	(*ImportTransactionsRequest)(nil),        // 78: float.v1.ImportTransactionsRequest
	(*ImportTransactionsResponse)(nil),       // 79: float.v1.ImportTransactionsResponse
	(*GetImportedTransactionsRequest)(nil),   // 80: float.v1.GetImportedTransactionsRequest
	(*ImportSummary)(nil),                    // 81: float.v1.ImportSummary
	(*ListImportsRequest)(nil),               // 82: float.v1.ListImportsRequest
	(*ListImportsResponse)(nil),              // 83: float.v1.ListImportsResponse
	(*TransactionRule)(nil),                  // 84: float.v1.TransactionRule
	(*ListRulesRequest)(nil),                 // 85: float.v1.ListRulesRequest
	(*ListRulesResponse)(nil),                // 86: float.v1.ListRulesResponse
	(*AddRuleRequest)(nil),                   // 87: float.v1.AddRuleRequest
	(*AddRuleResponse)(nil),                  // 88: float.v1.AddRuleResponse
	(*UpdateRuleRequest)(nil),                // 89: float.v1.UpdateRuleRequest
	(*UpdateRuleResponse)(nil),               // 90: float.v1.UpdateRuleResponse
	(*DeleteRuleRequest)(nil),                // 91: float.v1.DeleteRuleRequest
	(*DeleteRuleResponse)(nil),               // 92: float.v1.DeleteRuleResponse
	(*PreviewApplyRulesRequest)(nil),         // 93: float.v1.PreviewApplyRulesRequest
	(*RuleApplicationPreview)(nil),           // 94: float.v1.RuleApplicationPreview
	(*PreviewApplyRulesResponse)(nil),        // 95: float.v1.PreviewApplyRulesResponse
	(*ApplyRulesRequest)(nil),                // 96: float.v1.ApplyRulesRequest
	(*ApplyRulesResponse)(nil),               // 97: float.v1.ApplyRulesResponse
	nil,                                      // 98: float.v1.Transaction.TagsEntry
	nil,                                      // 99: float.v1.ModifyTagsRequest.TagsEntry
	nil,                                      // 100: float.v1.AddTransactionRequest.TagsEntry
	nil,                                      // 101: float.v1.UpdateTransactionRequest.TagsEntry
	nil,                                      // 102: float.v1.TransactionRule.TagsEntry
	nil,                                      // 103: float.v1.AddRuleRequest.TagsEntry
	nil,                                      // 104: float.v1.UpdateRuleRequest.TagsEntry
	nil,                                      // 105: float.v1.RuleApplicationPreview.AddTagsEntry
}
var file_float_v1_ledger_proto_depIdxs = []int32{
	...
	98,  // 2: float.v1.Transaction.tags:type_name -> float.v1.Transaction.TagsEntry
	...
	99,  // 16: float.v1.ModifyTagsRequest.tags:type_name -> float.v1.ModifyTagsRequest.TagsEntry
	...
	100, // 19: float.v1.AddTransactionRequest.tags:type_name -> float.v1.AddTransactionRequest.TagsEntry
	2,   // 20: float.v1.AddTransactionResponse.transaction:type_name -> float.v1.Transaction
	28,  // 21: float.v1.UpdateTransactionRequest.postings:type_name -> float.v1.PostingInput
	101, // 22: float.v1.UpdateTransactionRequest.tags:type_name -> float.v1.UpdateTransactionRequest.TagsEntry
	2,   // 23: float.v1.UpdateTransactionResponse.transaction:type_name -> float.v1.Transaction
	2,   // 24: float.v1.UpdateTransactionStatusResponse.transaction:type_name -> float.v1.Transaction
	0,   // 25: float.v1.PriceDirective.price:type_name -> float.v1.Amount
	35,  // 26: float.v1.ListPricesResponse.prices:type_name -> float.v1.PriceDirective
	35,  // 27: float.v1.AddPriceResponse.price:type_name -> float.v1.PriceDirective
	35,  // 28: float.v1.BackfillPricesResponse.prices:type_name -> float.v1.PriceDirective
	44,  // 29: float.v1.ListAccountDeclarationsResponse.declarations:type_name -> float.v1.AccountDeclaration
	44,  // 30: float.v1.DeclareAccountResponse.declaration:type_name -> float.v1.AccountDeclaration
	51,  // 31: float.v1.BulkEditOperation.mark_reviewed:type_name -> float.v1.MarkReviewedOperation
	52,  // 32: float.v1.BulkEditOperation.add_tag:type_name -> float.v1.AddTagOperation
	53,  // 33: float.v1.BulkEditOperation.remove_tag:type_name -> float.v1.RemoveTagOperation
	54,  // 34: float.v1.BulkEditOperation.set_payee:type_name -> float.v1.SetPayeeOperation
	55,  // 35: float.v1.BulkEditOperation.clear_payee:type_name -> float.v1.ClearPayeeOperation
	56,  // 36: float.v1.BulkEditTransactionsRequest.operations:type_name -> float.v1.BulkEditOperation
	2,   // 37: float.v1.BulkEditTransactionsResponse.transactions:type_name -> float.v1.Transaction
	59,  // 38: float.v1.ListSnapshotsResponse.snapshots:type_name -> float.v1.Snapshot
	64,  // 39: float.v1.ListBankProfilesResponse.profiles:type_name -> float.v1.BankProfile
	64,  // 40: float.v1.CreateBankProfileResponse.profile:type_name -> float.v1.BankProfile
	64,  // 41: float.v1.UpdateBankProfileResponse.profile:type_name -> float.v1.BankProfile
	2,   // 42: float.v1.ImportCandidate.transaction:type_name -> float.v1.Transaction
	76,  // 43: float.v1.PreviewImportResponse.candidates:type_name -> float.v1.ImportCandidate
	2,   // 44: float.v1.ImportTransactionsResponse.transactions:type_name -> float.v1.Transaction
	81,  // 45: float.v1.ListImportsResponse.imports:type_name -> float.v1.ImportSummary
	102, // 46: float.v1.TransactionRule.tags:type_name -> float.v1.TransactionRule.TagsEntry
	84,  // 47: float.v1.ListRulesResponse.rules:type_name -> float.v1.TransactionRule
	103, // 48: float.v1.AddRuleRequest.tags:type_name -> float.v1.AddRuleRequest.TagsEntry
	84,  // 49: float.v1.AddRuleResponse.rule:type_name -> float.v1.TransactionRule
	104, // 50: float.v1.UpdateRuleRequest.tags:type_name -> float.v1.UpdateRuleRequest.TagsEntry
	84,  // 51: float.v1.UpdateRuleResponse.rule:type_name -> float.v1.TransactionRule
	105, // 52: float.v1.RuleApplicationPreview.add_tags:type_name -> float.v1.RuleApplicationPreview.AddTagsEntry
	94,  // 53: float.v1.PreviewApplyRulesResponse.previews:type_name -> float.v1.RuleApplicationPreview
	9,   // 54: float.v1.LedgerService.ListTransactions:input_type -> float.v1.ListTransactionsRequest
	14,  // 55: float.v1.LedgerService.GetAccountRegister:input_type -> float.v1.GetAccountRegisterRequest
	11,  // 56: float.v1.LedgerService.GetBalances:input_type -> float.v1.GetBalancesRequest
	16,  // 57: float.v1.LedgerService.ListAccounts:input_type -> float.v1.ListAccountsRequest
	18,  // 58: float.v1.LedgerService.ListTags:input_type -> float.v1.ListTagsRequest
	20,  // 59: float.v1.LedgerService.ListPayees:input_type -> float.v1.ListPayeesRequest
	22,  // 60: float.v1.LedgerService.DeleteTransaction:input_type -> float.v1.DeleteTransactionRequest
	24,  // 61: float.v1.LedgerService.ModifyTags:input_type -> float.v1.ModifyTagsRequest
	26,  // 62: float.v1.LedgerService.UpdateTransactionDate:input_type -> float.v1.UpdateTransactionDateRequest
	31,  // 63: float.v1.LedgerService.UpdateTransaction:input_type -> float.v1.UpdateTransactionRequest
	29,  // 64: float.v1.LedgerService.AddTransaction:input_type -> float.v1.AddTransactionRequest
	33,  // 65: float.v1.LedgerService.UpdateTransactionStatus:input_type -> float.v1.UpdateTransactionStatusRequest
	7,   // 66: float.v1.LedgerService.GetNetWorthTimeseries:input_type -> float.v1.GetNetWorthTimeseriesRequest
	36,  // 67: float.v1.LedgerService.ListPrices:input_type -> float.v1.ListPricesRequest
	38,  // 68: float.v1.LedgerService.AddPrice:input_type -> float.v1.AddPriceRequest
	40,  // 69: float.v1.LedgerService.DeletePrice:input_type -> float.v1.DeletePriceRequest
	42,  // 70: float.v1.LedgerService.BackfillPrices:input_type -> float.v1.BackfillPricesRequest
	45,  // 71: float.v1.LedgerService.ListAccountDeclarations:input_type -> float.v1.ListAccountDeclarationsRequest
	47,  // 72: float.v1.LedgerService.DeclareAccount:input_type -> float.v1.DeclareAccountRequest
	49,  // 73: float.v1.LedgerService.DeleteAccountDeclaration:input_type -> float.v1.DeleteAccountDeclarationRequest
	57,  // 74: float.v1.LedgerService.BulkEditTransactions:input_type -> float.v1.BulkEditTransactionsRequest
	60,  // 75: float.v1.LedgerService.ListSnapshots:input_type -> float.v1.ListSnapshotsRequest
	62,  // 76: float.v1.LedgerService.RestoreSnapshot:input_type -> float.v1.RestoreSnapshotRequest
	65,  // 77: float.v1.LedgerService.ListBankProfiles:input_type -> float.v1.ListBankProfilesRequest
	67,  // 78: float.v1.LedgerService.CreateBankProfile:input_type -> float.v1.CreateBankProfileRequest
	69,  // 79: float.v1.LedgerService.GetBankProfileContent:input_type -> float.v1.GetBankProfileContentRequest
	71,  // 80: float.v1.LedgerService.UpdateBankProfile:input_type -> float.v1.UpdateBankProfileRequest
	73,  // 81: float.v1.LedgerService.DeleteBankProfile:input_type -> float.v1.DeleteBankProfileRequest
	75,  // 82: float.v1.LedgerService.PreviewImport:input_type -> float.v1.PreviewImportRequest
	78,  // 83: float.v1.LedgerService.ImportTransactions:input_type -> float.v1.ImportTransactionsRequest
	80,  // 84: float.v1.LedgerService.GetImportedTransactions:input_type -> float.v1.GetImportedTransactionsRequest
	82,  // 85: float.v1.LedgerService.ListImports:input_type -> float.v1.ListImportsRequest
	85,  // 86: float.v1.LedgerService.ListRules:input_type -> float.v1.ListRulesRequest
	87,  // 87: float.v1.LedgerService.AddRule:input_type -> float.v1.AddRuleRequest
	89,  // 88: float.v1.LedgerService.UpdateRule:input_type -> float.v1.UpdateRuleRequest
	91,  // 89: float.v1.LedgerService.DeleteRule:input_type -> float.v1.DeleteRuleRequest
	93,  // 90: float.v1.LedgerService.PreviewApplyRules:input_type -> float.v1.PreviewApplyRulesRequest
	96,  // 91: float.v1.LedgerService.ApplyRules:input_type -> float.v1.ApplyRulesRequest
	10,  // 92: float.v1.LedgerService.ListTransactions:output_type -> float.v1.ListTransactionsResponse
	15,  // 93: float.v1.LedgerService.GetAccountRegister:output_type -> float.v1.GetAccountRegisterResponse
	12,  // 94: float.v1.LedgerService.GetBalances:output_type -> float.v1.GetBalancesResponse
	17,  // 95: float.v1.LedgerService.ListAccounts:output_type -> float.v1.ListAccountsResponse
	19,  // 96: float.v1.LedgerService.ListTags:output_type -> float.v1.ListTagsResponse
	21,  // 97: float.v1.LedgerService.ListPayees:output_type -> float.v1.ListPayeesResponse
	23,  // 98: float.v1.LedgerService.DeleteTransaction:output_type -> float.v1.DeleteTransactionResponse
	25,  // 99: float.v1.LedgerService.ModifyTags:output_type -> float.v1.ModifyTagsResponse
	27,  // 100: float.v1.LedgerService.UpdateTransactionDate:output_type -> float.v1.UpdateTransactionDateResponse
	32,  // 101: float.v1.LedgerService.UpdateTransaction:output_type -> float.v1.UpdateTransactionResponse
	30,  // 102: float.v1.LedgerService.AddTransaction:output_type -> float.v1.AddTransactionResponse
	34,  // 103: float.v1.LedgerService.UpdateTransactionStatus:output_type -> float.v1.UpdateTransactionStatusResponse
	8,   // 104: float.v1.LedgerService.GetNetWorthTimeseries:output_type -> float.v1.GetNetWorthTimeseriesResponse
	37,  // 105: float.v1.LedgerService.ListPrices:output_type -> float.v1.ListPricesResponse
	39,  // 106: float.v1.LedgerService.AddPrice:output_type -> float.v1.AddPriceResponse
	41,  // 107: float.v1.LedgerService.DeletePrice:output_type -> float.v1.DeletePriceResponse
	43,  // 108: float.v1.LedgerService.BackfillPrices:output_type -> float.v1.BackfillPricesResponse
	46,  // 109: float.v1.LedgerService.ListAccountDeclarations:output_type -> float.v1.ListAccountDeclarationsResponse
	48,  // 110: float.v1.LedgerService.DeclareAccount:output_type -> float.v1.DeclareAccountResponse
	50,  // 111: float.v1.LedgerService.DeleteAccountDeclaration:output_type -> float.v1.DeleteAccountDeclarationResponse
	58,  // 112: float.v1.LedgerService.BulkEditTransactions:output_type -> float.v1.BulkEditTransactionsResponse
	61,  // 113: float.v1.LedgerService.ListSnapshots:output_type -> float.v1.ListSnapshotsResponse
	63,  // 114: float.v1.LedgerService.RestoreSnapshot:output_type -> float.v1.RestoreSnapshotResponse
	66,  // 115: float.v1.LedgerService.ListBankProfiles:output_type -> float.v1.ListBankProfilesResponse
	68,  // 116: float.v1.LedgerService.CreateBankProfile:output_type -> float.v1.CreateBankProfileResponse
	70,  // 117: float.v1.LedgerService.GetBankProfileContent:output_type -> float.v1.GetBankProfileContentResponse
	72,  // 118: float.v1.LedgerService.UpdateBankProfile:output_type -> float.v1.UpdateBankProfileResponse
	74,  // 119: float.v1.LedgerService.DeleteBankProfile:output_type -> float.v1.DeleteBankProfileResponse
	77,  // 120: float.v1.LedgerService.PreviewImport:output_type -> float.v1.PreviewImportResponse
	79,  // 121: float.v1.LedgerService.ImportTransactions:output_type -> float.v1.ImportTransactionsResponse
	10,  // 122: float.v1.LedgerService.GetImportedTransactions:output_type -> float.v1.ListTransactionsResponse
	83,  // 123: float.v1.LedgerService.ListImports:output_type -> float.v1.ListImportsResponse
	86,  // 124: float.v1.LedgerService.ListRules:output_type -> float.v1.ListRulesResponse
	88,  // 125: float.v1.LedgerService.AddRule:output_type -> float.v1.AddRuleResponse
	90,  // 126: float.v1.LedgerService.UpdateRule:output_type -> float.v1.UpdateRuleResponse
	92,  // 127: float.v1.LedgerService.DeleteRule:output_type -> float.v1.DeleteRuleResponse
	95,  // 128: float.v1.LedgerService.PreviewApplyRules:output_type -> float.v1.PreviewApplyRulesResponse
	97,  // 129: float.v1.LedgerService.ApplyRules:output_type -> float.v1.ApplyRulesResponse
...
func file_float_v1_ledger_proto_init() {
	...
	file_float_v1_ledger_proto_msgTypes[56].OneofWrappers = []any{
