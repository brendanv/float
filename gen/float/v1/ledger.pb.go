...
func (x *AccountDeclaration) GetAid() string {
	if x != nil {
		return x.Aid
	}
	return ""
...
type DeleteAccountDeclarationRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Aid           string                 `protobuf:"bytes,1,opt,name=aid,proto3" json:"aid,omitempty"` // AID of the declaration to delete
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DeleteAccountDeclarationRequest) GetAid() string {
	if x != nil {
		return x.Aid
	}
	return ""
...
const file_float_v1_ledger_proto_rawDesc = "" +
	...
	"\vdeclaration\x18\x01 \x01(\v2\x1c.float.v1.AccountDeclarationR\vdeclaration\"3\n" +
	"\x1fDeleteAccountDeclarationRequest\x12\x10\n" +
	...
	"\rapplied_count\x18\x01 \x01(\x05R\fappliedCount2\xb7\x19\n" +
	"\rLedgerService\x12Y\n" +
	...
	"\vDeletePrice\x12\x1c.float.v1.DeletePriceRequest\x1a\x1d.float.v1.DeletePriceResponse\x12n\n" +
...
var file_float_v1_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 104)
var file_float_v1_ledger_proto_goTypes = []any{
	...
	(*AccountDeclaration)(nil),               // 42: float.v1.AccountDeclaration
	(*ListAccountDeclarationsRequest)(nil),   // 43: float.v1.ListAccountDeclarationsRequest
	(*ListAccountDeclarationsResponse)(nil),  // 44: float.v1.ListAccountDeclarationsResponse
	(*DeclareAccountRequest)(nil),            // 45: float.v1.DeclareAccountRequest
	(*DeclareAccountResponse)(nil),           // 46: float.v1.DeclareAccountResponse
	(*DeleteAccountDeclarationRequest)(nil),  // 47: float.v1.DeleteAccountDeclarationRequest
	(*DeleteAccountDeclarationResponse)(nil), // 48: float.v1.DeleteAccountDeclarationResponse
	(*MarkReviewedOperation)(nil),            // 49: float.v1.MarkReviewedOperation
	(*AddTagOperation)(nil),                  // 50: float.v1.AddTagOperation
	(*RemoveTagOperation)(nil),               // 51: float.v1.RemoveTagOperation
	(*SetPayeeOperation)(nil),                // 52: float.v1.SetPayeeOperation
	(*ClearPayeeOperation)(nil),              // 53: float.v1.ClearPayeeOperation
	(*BulkEditOperation)(nil),                // 54: float.v1.BulkEditOperation
	(*BulkEditTransactionsRequest)(nil),      // 55: float.v1.BulkEditTransactionsRequest
	(*BulkEditTransactionsResponse)(nil),     // 56: float.v1.BulkEditTransactionsResponse
	(*Snapshot)(nil),                         // 57: float.v1.Snapshot
	(*ListSnapshotsRequest)(nil),             // 58: float.v1.ListSnapshotsRequest
	(*ListSnapshotsResponse)(nil),            // 59: float.v1.ListSnapshotsResponse
	(*RestoreSnapshotRequest)(nil),           // 60: float.v1.RestoreSnapshotRequest
	(*RestoreSnapshotResponse)(nil),          // 61: float.v1.RestoreSnapshotResponse
	(*BankProfile)(nil),                      // 62: float.v1.BankProfile
	(*ListBankProfilesRequest)(nil),          // 63: float.v1.ListBankProfilesRequest
	(*ListBankProfilesResponse)(nil),         // 64: float.v1.ListBankProfilesResponse
	(*CreateBankProfileRequest)(nil),         // 65: float.v1.CreateBankProfileRequest
	(*CreateBankProfileResponse)(nil),        // 66: float.v1.CreateBankProfileResponse
	(*GetBankProfileContentRequest)(nil),     // 67: float.v1.GetBankProfileContentRequest
	(*GetBankProfileContentResponse)(nil),    // 68: float.v1.GetBankProfileContentResponse
	(*UpdateBankProfileRequest)(nil),         // 69: float.v1.UpdateBankProfileRequest
	(*UpdateBankProfileResponse)(nil),        // 70: float.v1.UpdateBankProfileResponse
	(*DeleteBankProfileRequest)(nil),         // 71: float.v1.DeleteBankProfileRequest
	(*DeleteBankProfileResponse)(nil),        // 72: float.v1.DeleteBankProfileResponse
	(*PreviewImportRequest)(nil),             // 73: float.v1.PreviewImportRequest
	(*ImportCandidate)(nil),                  // 74: float.v1.ImportCandidate
	(*PreviewImportResponse)(nil),            // 75: float.v1.PreviewImportResponse
	(*ImportTransactionsRequest)(nil),        // 76: float.v1.ImportTransactionsRequest
	(*ImportTransactionsResponse)(nil),       // 77: float.v1.ImportTransactionsResponse
	(*GetImportedTransactionsRequest)(nil),   // 78: float.v1.GetImportedTransactionsRequest
	(*ImportSummary)(nil),                    // 79: float.v1.ImportSummary
	(*ListImportsRequest)(nil),               // 80: float.v1.ListImportsRequest
	(*ListImportsResponse)(nil),              // 81: float.v1.ListImportsResponse
	(*TransactionRule)(nil),                  // 82: float.v1.TransactionRule
	(*ListRulesRequest)(nil),                 // 83: float.v1.ListRulesRequest
	(*ListRulesResponse)(nil),                // 84: float.v1.ListRulesResponse
	(*AddRuleRequest)(nil),                   // 85: float.v1.AddRuleRequest
	(*AddRuleResponse)(nil),                  // 86: float.v1.AddRuleResponse
	(*UpdateRuleRequest)(nil),                // 87: float.v1.UpdateRuleRequest
	(*UpdateRuleResponse)(nil),               // 88: float.v1.UpdateRuleResponse
	(*DeleteRuleRequest)(nil),                // 89: float.v1.DeleteRuleRequest
	(*DeleteRuleResponse)(nil),               // 90: float.v1.DeleteRuleResponse
	(*PreviewApplyRulesRequest)(nil),         // 91: float.v1.PreviewApplyRulesRequest
	(*RuleApplicationPreview)(nil),           // 92: float.v1.RuleApplicationPreview
	(*PreviewApplyRulesResponse)(nil),        // 93: float.v1.PreviewApplyRulesResponse
	(*ApplyRulesRequest)(nil),                // 94: float.v1.ApplyRulesRequest
	(*ApplyRulesResponse)(nil),               // 95: float.v1.ApplyRulesResponse
	nil,                                      // 96: float.v1.Transaction.TagsEntry
	nil,                                      // 97: float.v1.ModifyTagsRequest.TagsEntry
	nil,                                      // 98: float.v1.AddTransactionRequest.TagsEntry
	nil,                                      // 99: float.v1.UpdateTransactionRequest.TagsEntry
	nil,                                      // 100: float.v1.TransactionRule.TagsEntry
	nil,                                      // 101: float.v1.AddRuleRequest.TagsEntry
	nil,                                      // 102: float.v1.UpdateRuleRequest.TagsEntry
	nil,                                      // 103: float.v1.RuleApplicationPreview.AddTagsEntry
}
var file_float_v1_ledger_proto_depIdxs = []int32{
	...
	96,  // 2: float.v1.Transaction.tags:type_name -> float.v1.Transaction.TagsEntry
	...
	97,  // 16: float.v1.ModifyTagsRequest.tags:type_name -> float.v1.ModifyTagsRequest.TagsEntry
	...
	98,  // 19: float.v1.AddTransactionRequest.tags:type_name -> float.v1.AddTransactionRequest.TagsEntry
	...
	99,  // 22: float.v1.UpdateTransactionRequest.tags:type_name -> float.v1.UpdateTransactionRequest.TagsEntry
	...
	42,  // 28: float.v1.ListAccountDeclarationsResponse.declarations:type_name -> float.v1.AccountDeclaration
	42,  // 29: float.v1.DeclareAccountResponse.declaration:type_name -> float.v1.AccountDeclaration
	49,  // 30: float.v1.BulkEditOperation.mark_reviewed:type_name -> float.v1.MarkReviewedOperation
	50,  // 31: float.v1.BulkEditOperation.add_tag:type_name -> float.v1.AddTagOperation
	51,  // 32: float.v1.BulkEditOperation.remove_tag:type_name -> float.v1.RemoveTagOperation
	52,  // 33: float.v1.BulkEditOperation.set_payee:type_name -> float.v1.SetPayeeOperation
	53,  // 34: float.v1.BulkEditOperation.clear_payee:type_name -> float.v1.ClearPayeeOperation
	54,  // 35: float.v1.BulkEditTransactionsRequest.operations:type_name -> float.v1.BulkEditOperation
	2,   // 36: float.v1.BulkEditTransactionsResponse.transactions:type_name -> float.v1.Transaction
	57,  // 37: float.v1.ListSnapshotsResponse.snapshots:type_name -> float.v1.Snapshot
	62,  // 38: float.v1.ListBankProfilesResponse.profiles:type_name -> float.v1.BankProfile
	62,  // 39: float.v1.CreateBankProfileResponse.profile:type_name -> float.v1.BankProfile
	62,  // 40: float.v1.UpdateBankProfileResponse.profile:type_name -> float.v1.BankProfile
	2,   // 41: float.v1.ImportCandidate.transaction:type_name -> float.v1.Transaction
	74,  // 42: float.v1.PreviewImportResponse.candidates:type_name -> float.v1.ImportCandidate
	2,   // 43: float.v1.ImportTransactionsResponse.transactions:type_name -> float.v1.Transaction
	79,  // 44: float.v1.ListImportsResponse.imports:type_name -> float.v1.ImportSummary
	100, // 45: float.v1.TransactionRule.tags:type_name -> float.v1.TransactionRule.TagsEntry
	82,  // 46: float.v1.ListRulesResponse.rules:type_name -> float.v1.TransactionRule
	101, // 47: float.v1.AddRuleRequest.tags:type_name -> float.v1.AddRuleRequest.TagsEntry
	82,  // 48: float.v1.AddRuleResponse.rule:type_name -> float.v1.TransactionRule
	102, // 49: float.v1.UpdateRuleRequest.tags:type_name -> float.v1.UpdateRuleRequest.TagsEntry
	82,  // 50: float.v1.UpdateRuleResponse.rule:type_name -> float.v1.TransactionRule
	103, // 51: float.v1.RuleApplicationPreview.add_tags:type_name -> float.v1.RuleApplicationPreview.AddTagsEntry
	92,  // 52: float.v1.PreviewApplyRulesResponse.previews:type_name -> float.v1.RuleApplicationPreview
	9,   // 53: float.v1.LedgerService.ListTransactions:input_type -> float.v1.ListTransactionsRequest
	14,  // 54: float.v1.LedgerService.GetAccountRegister:input_type -> float.v1.GetAccountRegisterRequest
	11,  // 55: float.v1.LedgerService.GetBalances:input_type -> float.v1.GetBalancesRequest
	16,  // 56: float.v1.LedgerService.ListAccounts:input_type -> float.v1.ListAccountsRequest
	18,  // 57: float.v1.LedgerService.ListTags:input_type -> float.v1.ListTagsRequest
	20,  // 58: float.v1.LedgerService.ListPayees:input_type -> float.v1.ListPayeesRequest
	22,  // 59: float.v1.LedgerService.DeleteTransaction:input_type -> float.v1.DeleteTransactionRequest
	24,  // 60: float.v1.LedgerService.ModifyTags:input_type -> float.v1.ModifyTagsRequest
	26,  // 61: float.v1.LedgerService.UpdateTransactionDate:input_type -> float.v1.UpdateTransactionDateRequest
	31,  // 62: float.v1.LedgerService.UpdateTransaction:input_type -> float.v1.UpdateTransactionRequest
	29,  // 63: float.v1.LedgerService.AddTransaction:input_type -> float.v1.AddTransactionRequest
	33,  // 64: float.v1.LedgerService.UpdateTransactionStatus:input_type -> float.v1.UpdateTransactionStatusRequest
	7,   // 65: float.v1.LedgerService.GetNetWorthTimeseries:input_type -> float.v1.GetNetWorthTimeseriesRequest
	36,  // 66: float.v1.LedgerService.ListPrices:input_type -> float.v1.ListPricesRequest
	38,  // 67: float.v1.LedgerService.AddPrice:input_type -> float.v1.AddPriceRequest
	40,  // 68: float.v1.LedgerService.DeletePrice:input_type -> float.v1.DeletePriceRequest
	43,  // 69: float.v1.LedgerService.ListAccountDeclarations:input_type -> float.v1.ListAccountDeclarationsRequest
	45,  // 70: float.v1.LedgerService.DeclareAccount:input_type -> float.v1.DeclareAccountRequest
	47,  // 71: float.v1.LedgerService.DeleteAccountDeclaration:input_type -> float.v1.DeleteAccountDeclarationRequest
	55,  // 72: float.v1.LedgerService.BulkEditTransactions:input_type -> float.v1.BulkEditTransactionsRequest
	58,  // 73: float.v1.LedgerService.ListSnapshots:input_type -> float.v1.ListSnapshotsRequest
	60,  // 74: float.v1.LedgerService.RestoreSnapshot:input_type -> float.v1.RestoreSnapshotRequest
	63,  // 75: float.v1.LedgerService.ListBankProfiles:input_type -> float.v1.ListBankProfilesRequest
	65,  // 76: float.v1.LedgerService.CreateBankProfile:input_type -> float.v1.CreateBankProfileRequest
	67,  // 77: float.v1.LedgerService.GetBankProfileContent:input_type -> float.v1.GetBankProfileContentRequest
	69,  // 78: float.v1.LedgerService.UpdateBankProfile:input_type -> float.v1.UpdateBankProfileRequest
	71,  // 79: float.v1.LedgerService.DeleteBankProfile:input_type -> float.v1.DeleteBankProfileRequest
	73,  // 80: float.v1.LedgerService.PreviewImport:input_type -> float.v1.PreviewImportRequest
	76,  // 81: float.v1.LedgerService.ImportTransactions:input_type -> float.v1.ImportTransactionsRequest
	78,  // 82: float.v1.LedgerService.GetImportedTransactions:input_type -> float.v1.GetImportedTransactionsRequest
	80,  // 83: float.v1.LedgerService.ListImports:input_type -> float.v1.ListImportsRequest
	83,  // 84: float.v1.LedgerService.ListRules:input_type -> float.v1.ListRulesRequest
	85,  // 85: float.v1.LedgerService.AddRule:input_type -> float.v1.AddRuleRequest
	87,  // 86: float.v1.LedgerService.UpdateRule:input_type -> float.v1.UpdateRuleRequest
	89,  // 87: float.v1.LedgerService.DeleteRule:input_type -> float.v1.DeleteRuleRequest
	91,  // 88: float.v1.LedgerService.PreviewApplyRules:input_type -> float.v1.PreviewApplyRulesRequest
	94,  // 89: float.v1.LedgerService.ApplyRules:input_type -> float.v1.ApplyRulesRequest
	10,  // 90: float.v1.LedgerService.ListTransactions:output_type -> float.v1.ListTransactionsResponse
	15,  // 91: float.v1.LedgerService.GetAccountRegister:output_type -> float.v1.GetAccountRegisterResponse
	12,  // 92: float.v1.LedgerService.GetBalances:output_type -> float.v1.GetBalancesResponse
	17,  // 93: float.v1.LedgerService.ListAccounts:output_type -> float.v1.ListAccountsResponse
	19,  // 94: float.v1.LedgerService.ListTags:output_type -> float.v1.ListTagsResponse
	21,  // 95: float.v1.LedgerService.ListPayees:output_type -> float.v1.ListPayeesResponse
	23,  // 96: float.v1.LedgerService.DeleteTransaction:output_type -> float.v1.DeleteTransactionResponse
	25,  // 97: float.v1.LedgerService.ModifyTags:output_type -> float.v1.ModifyTagsResponse
	27,  // 98: float.v1.LedgerService.UpdateTransactionDate:output_type -> float.v1.UpdateTransactionDateResponse
	32,  // 99: float.v1.LedgerService.UpdateTransaction:output_type -> float.v1.UpdateTransactionResponse
	30,  // 100: float.v1.LedgerService.AddTransaction:output_type -> float.v1.AddTransactionResponse
	34,  // 101: float.v1.LedgerService.UpdateTransactionStatus:output_type -> float.v1.UpdateTransactionStatusResponse
	8,   // 102: float.v1.LedgerService.GetNetWorthTimeseries:output_type -> float.v1.GetNetWorthTimeseriesResponse
	37,  // 103: float.v1.LedgerService.ListPrices:output_type -> float.v1.ListPricesResponse
	39,  // 104: float.v1.LedgerService.AddPrice:output_type -> float.v1.AddPriceResponse
	41,  // 105: float.v1.LedgerService.DeletePrice:output_type -> float.v1.DeletePriceResponse
	44,  // 106: float.v1.LedgerService.ListAccountDeclarations:output_type -> float.v1.ListAccountDeclarationsResponse
	46,  // 107: float.v1.LedgerService.DeclareAccount:output_type -> float.v1.DeclareAccountResponse
	48,  // 108: float.v1.LedgerService.DeleteAccountDeclaration:output_type -> float.v1.DeleteAccountDeclarationResponse
	56,  // 109: float.v1.LedgerService.BulkEditTransactions:output_type -> float.v1.BulkEditTransactionsResponse
	59,  // 110: float.v1.LedgerService.ListSnapshots:output_type -> float.v1.ListSnapshotsResponse
	61,  // 111: float.v1.LedgerService.RestoreSnapshot:output_type -> float.v1.RestoreSnapshotResponse
	64,  // 112: float.v1.LedgerService.ListBankProfiles:output_type -> float.v1.ListBankProfilesResponse
	66,  // 113: float.v1.LedgerService.CreateBankProfile:output_type -> float.v1.CreateBankProfileResponse
	68,  // 114: float.v1.LedgerService.GetBankProfileContent:output_type -> float.v1.GetBankProfileContentResponse
	70,  // 115: float.v1.LedgerService.UpdateBankProfile:output_type -> float.v1.UpdateBankProfileResponse
	72,  // 116: float.v1.LedgerService.DeleteBankProfile:output_type -> float.v1.DeleteBankProfileResponse
	75,  // 117: float.v1.LedgerService.PreviewImport:output_type -> float.v1.PreviewImportResponse
	77,  // 118: float.v1.LedgerService.ImportTransactions:output_type -> float.v1.ImportTransactionsResponse
	10,  // 119: float.v1.LedgerService.GetImportedTransactions:output_type -> float.v1.ListTransactionsResponse
	81,  // 120: float.v1.LedgerService.ListImports:output_type -> float.v1.ListImportsResponse
	84,  // 121: float.v1.LedgerService.ListRules:output_type -> float.v1.ListRulesResponse
	86,  // 122: float.v1.LedgerService.AddRule:output_type -> float.v1.AddRuleResponse
	88,  // 123: float.v1.LedgerService.UpdateRule:output_type -> float.v1.UpdateRuleResponse
	90,  // 124: float.v1.LedgerService.DeleteRule:output_type -> float.v1.DeleteRuleResponse
	93,  // 125: float.v1.LedgerService.PreviewApplyRules:output_type -> float.v1.PreviewApplyRulesResponse
	95,  // 126: float.v1.LedgerService.ApplyRules:output_type -> float.v1.ApplyRulesResponse
...
func file_float_v1_ledger_proto_init() {
	...
	file_float_v1_ledger_proto_msgTypes[54].OneofWrappers = []any{
