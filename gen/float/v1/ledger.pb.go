...
const file_float_v1_ledger_proto_rawDesc = "" +
	...
	"\x06amount\x18\x01 \x01(\v2\x10.float.v1.AmountR\x06amount2\x90.\n" +
	"\rLedgerService\x12Y\n" +
...
var file_float_v1_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 173)
var file_float_v1_ledger_proto_goTypes = []any{
	...
	nil,                                          // 163: float.v1.Transaction.TagsEntry
	nil,                                          // 164: float.v1.AccountRegisterRow.TagsEntry
	nil,                                          // 165: float.v1.ModifyTagsRequest.TagsEntry
	nil,                                          // 166: float.v1.AddTransactionRequest.TagsEntry
	nil,                                          // 167: float.v1.UpdateTransactionRequest.TagsEntry
	nil,                                          // 168: float.v1.TransactionRule.TagsEntry
	nil,                                          // 169: float.v1.RuleInput.TagsEntry
	nil,                                          // 170: float.v1.UpdateRuleRequest.TagsEntry
	nil,                                          // 171: float.v1.RuleApplicationPreview.AddTagsEntry
	nil,                                          // 172: float.v1.SuggestedRule.TagsEntry
}
var file_float_v1_ledger_proto_depIdxs = []int32{
	...
	163, // 4: float.v1.Transaction.tags:type_name -> float.v1.Transaction.TagsEntry
	...
	164, // 21: float.v1.AccountRegisterRow.tags:type_name -> float.v1.AccountRegisterRow.TagsEntry
	...
	165, // 24: float.v1.ModifyTagsRequest.tags:type_name -> float.v1.ModifyTagsRequest.TagsEntry
	...
	166, // 29: float.v1.AddTransactionRequest.tags:type_name -> float.v1.AddTransactionRequest.TagsEntry
	...
	167, // 32: float.v1.UpdateTransactionRequest.tags:type_name -> float.v1.UpdateTransactionRequest.TagsEntry
	...
	168, // 59: float.v1.TransactionRule.tags:type_name -> float.v1.TransactionRule.TagsEntry
	98,  // 60: float.v1.ListRulesResponse.rules:type_name -> float.v1.TransactionRule
	169, // 61: float.v1.RuleInput.tags:type_name -> float.v1.RuleInput.TagsEntry
	...
	170, // 64: float.v1.UpdateRuleRequest.tags:type_name -> float.v1.UpdateRuleRequest.TagsEntry
	98,  // 65: float.v1.UpdateRuleResponse.rule:type_name -> float.v1.TransactionRule
	171, // 66: float.v1.RuleApplicationPreview.add_tags:type_name -> float.v1.RuleApplicationPreview.AddTagsEntry
	...
	172, // 84: float.v1.SuggestedRule.tags:type_name -> float.v1.SuggestedRule.TagsEntry
	...
	13,  // 87: float.v1.LedgerService.ListTransactions:input_type -> float.v1.ListTransactionsRequest
	18,  // 88: float.v1.LedgerService.GetAccountRegister:input_type -> float.v1.GetAccountRegisterRequest
	15,  // 89: float.v1.LedgerService.GetBalances:input_type -> float.v1.GetBalancesRequest
	20,  // 90: float.v1.LedgerService.ListAccounts:input_type -> float.v1.ListAccountsRequest
	22,  // 91: float.v1.LedgerService.ListTags:input_type -> float.v1.ListTagsRequest
	24,  // 92: float.v1.LedgerService.ListPayees:input_type -> float.v1.ListPayeesRequest
	26,  // 93: float.v1.LedgerService.DeleteTransaction:input_type -> float.v1.DeleteTransactionRequest
	28,  // 94: float.v1.LedgerService.ModifyTags:input_type -> float.v1.ModifyTagsRequest
	30,  // 95: float.v1.LedgerService.UpdateTransactionDate:input_type -> float.v1.UpdateTransactionDateRequest
	36,  // 96: float.v1.LedgerService.UpdateTransaction:input_type -> float.v1.UpdateTransactionRequest
	34,  // 97: float.v1.LedgerService.AddTransaction:input_type -> float.v1.AddTransactionRequest
	38,  // 98: float.v1.LedgerService.UpdateTransactionStatus:input_type -> float.v1.UpdateTransactionStatusRequest
	7,   // 99: float.v1.LedgerService.GetNetWorthTimeseries:input_type -> float.v1.GetNetWorthTimeseriesRequest
	114, // 100: float.v1.LedgerService.GetPortfolioHoldings:input_type -> float.v1.GetPortfolioHoldingsRequest
	116, // 101: float.v1.LedgerService.GetPortfolioTimeseries:input_type -> float.v1.GetPortfolioTimeseriesRequest
	41,  // 102: float.v1.LedgerService.ListPrices:input_type -> float.v1.ListPricesRequest
	43,  // 103: float.v1.LedgerService.AddPrice:input_type -> float.v1.AddPriceRequest
	45,  // 104: float.v1.LedgerService.DeletePrice:input_type -> float.v1.DeletePriceRequest
	47,  // 105: float.v1.LedgerService.BackfillPrices:input_type -> float.v1.BackfillPricesRequest
	50,  // 106: float.v1.LedgerService.ListAccountDeclarations:input_type -> float.v1.ListAccountDeclarationsRequest
	52,  // 107: float.v1.LedgerService.DeclareAccount:input_type -> float.v1.DeclareAccountRequest
	54,  // 108: float.v1.LedgerService.DeleteAccountDeclaration:input_type -> float.v1.DeleteAccountDeclarationRequest
	56,  // 109: float.v1.LedgerService.RenameAccount:input_type -> float.v1.RenameAccountRequest
	64,  // 110: float.v1.LedgerService.BulkEditTransactions:input_type -> float.v1.BulkEditTransactionsRequest
	67,  // 111: float.v1.LedgerService.ListSnapshots:input_type -> float.v1.ListSnapshotsRequest
	69,  // 112: float.v1.LedgerService.RestoreSnapshot:input_type -> float.v1.RestoreSnapshotRequest
	72,  // 113: float.v1.LedgerService.GetSnapshotDiff:input_type -> float.v1.GetSnapshotDiffRequest
	11,  // 114: float.v1.LedgerService.GetIncomeStatementTimeseries:input_type -> float.v1.GetIncomeStatementTimeseriesRequest
	75,  // 115: float.v1.LedgerService.ListBankProfiles:input_type -> float.v1.ListBankProfilesRequest
	77,  // 116: float.v1.LedgerService.CreateBankProfile:input_type -> float.v1.CreateBankProfileRequest
	79,  // 117: float.v1.LedgerService.GetBankProfileContent:input_type -> float.v1.GetBankProfileContentRequest
	81,  // 118: float.v1.LedgerService.UpdateBankProfile:input_type -> float.v1.UpdateBankProfileRequest
	83,  // 119: float.v1.LedgerService.DeleteBankProfile:input_type -> float.v1.DeleteBankProfileRequest
	85,  // 120: float.v1.LedgerService.PreviewImport:input_type -> float.v1.PreviewImportRequest
	88,  // 121: float.v1.LedgerService.ImportTransactions:input_type -> float.v1.ImportTransactionsRequest
	92,  // 122: float.v1.LedgerService.GetImportedTransactions:input_type -> float.v1.GetImportedTransactionsRequest
	94,  // 123: float.v1.LedgerService.ListImports:input_type -> float.v1.ListImportsRequest
	96,  // 124: float.v1.LedgerService.GetImportFile:input_type -> float.v1.GetImportFileRequest
	99,  // 125: float.v1.LedgerService.ListRules:input_type -> float.v1.ListRulesRequest
	102, // 126: float.v1.LedgerService.AddRule:input_type -> float.v1.AddRuleRequest
	104, // 127: float.v1.LedgerService.UpdateRule:input_type -> float.v1.UpdateRuleRequest
	106, // 128: float.v1.LedgerService.DeleteRule:input_type -> float.v1.DeleteRuleRequest
	108, // 129: float.v1.LedgerService.PreviewApplyRules:input_type -> float.v1.PreviewApplyRulesRequest
	111, // 130: float.v1.LedgerService.ApplyRules:input_type -> float.v1.ApplyRulesRequest
	120, // 131: float.v1.LedgerService.GetStripeConfig:input_type -> float.v1.GetStripeConfigRequest
	126, // 132: float.v1.LedgerService.CreateStripeLinkSession:input_type -> float.v1.CreateStripeLinkSessionRequest
	129, // 133: float.v1.LedgerService.CompleteStripeLinking:input_type -> float.v1.CompleteStripeLinkingRequest
	131, // 134: float.v1.LedgerService.ListStripeLinkedAccounts:input_type -> float.v1.ListStripeLinkedAccountsRequest
	133, // 135: float.v1.LedgerService.UnlinkStripeAccount:input_type -> float.v1.UnlinkStripeAccountRequest
	135, // 136: float.v1.LedgerService.FetchStripeTransactions:input_type -> float.v1.FetchStripeTransactionsRequest
	137, // 137: float.v1.LedgerService.ImportStripeTransactions:input_type -> float.v1.ImportStripeTransactionsRequest
	139, // 138: float.v1.LedgerService.FetchAllStripeTransactions:input_type -> float.v1.FetchAllStripeTransactionsRequest
	142, // 139: float.v1.LedgerService.ImportAllStripeTransactions:input_type -> float.v1.ImportAllStripeTransactionsRequest
	144, // 140: float.v1.LedgerService.SuggestRules:input_type -> float.v1.SuggestRulesRequest
	146, // 141: float.v1.LedgerService.TranslateQuery:input_type -> float.v1.TranslateQueryRequest
	148, // 142: float.v1.LedgerService.AskQuestion:input_type -> float.v1.AskQuestionRequest
	150, // 143: float.v1.LedgerService.GetAlphaVantageConfig:input_type -> float.v1.GetAlphaVantageConfigRequest
	152, // 144: float.v1.LedgerService.SetAlphaVantageApiKey:input_type -> float.v1.SetAlphaVantageApiKeyRequest
	154, // 145: float.v1.LedgerService.GetAIConfig:input_type -> float.v1.GetAIConfigRequest
	156, // 146: float.v1.LedgerService.SetAIModel:input_type -> float.v1.SetAIModelRequest
	158, // 147: float.v1.LedgerService.SetAIPrompt:input_type -> float.v1.SetAIPromptRequest
	124, // 148: float.v1.LedgerService.SetStripeCustomerId:input_type -> float.v1.SetStripeCustomerIdRequest
	122, // 149: float.v1.LedgerService.SetStripeDailyImportEnabled:input_type -> float.v1.SetStripeDailyImportEnabledRequest
	160, // 150: float.v1.LedgerService.RunHledgerQuery:input_type -> float.v1.RunHledgerQueryRequest
	14,  // 151: float.v1.LedgerService.ListTransactions:output_type -> float.v1.ListTransactionsResponse
	19,  // 152: float.v1.LedgerService.GetAccountRegister:output_type -> float.v1.GetAccountRegisterResponse
	16,  // 153: float.v1.LedgerService.GetBalances:output_type -> float.v1.GetBalancesResponse
	21,  // 154: float.v1.LedgerService.ListAccounts:output_type -> float.v1.ListAccountsResponse
	23,  // 155: float.v1.LedgerService.ListTags:output_type -> float.v1.ListTagsResponse
	25,  // 156: float.v1.LedgerService.ListPayees:output_type -> float.v1.ListPayeesResponse
	27,  // 157: float.v1.LedgerService.DeleteTransaction:output_type -> float.v1.DeleteTransactionResponse
	29,  // 158: float.v1.LedgerService.ModifyTags:output_type -> float.v1.ModifyTagsResponse
	31,  // 159: float.v1.LedgerService.UpdateTransactionDate:output_type -> float.v1.UpdateTransactionDateResponse
	37,  // 160: float.v1.LedgerService.UpdateTransaction:output_type -> float.v1.UpdateTransactionResponse
	35,  // 161: float.v1.LedgerService.AddTransaction:output_type -> float.v1.AddTransactionResponse
	39,  // 162: float.v1.LedgerService.UpdateTransactionStatus:output_type -> float.v1.UpdateTransactionStatusResponse
	8,   // 163: float.v1.LedgerService.GetNetWorthTimeseries:output_type -> float.v1.GetNetWorthTimeseriesResponse
	115, // 164: float.v1.LedgerService.GetPortfolioHoldings:output_type -> float.v1.GetPortfolioHoldingsResponse
	118, // 165: float.v1.LedgerService.GetPortfolioTimeseries:output_type -> float.v1.GetPortfolioTimeseriesResponse
	42,  // 166: float.v1.LedgerService.ListPrices:output_type -> float.v1.ListPricesResponse
	44,  // 167: float.v1.LedgerService.AddPrice:output_type -> float.v1.AddPriceResponse
	46,  // 168: float.v1.LedgerService.DeletePrice:output_type -> float.v1.DeletePriceResponse
	48,  // 169: float.v1.LedgerService.BackfillPrices:output_type -> float.v1.BackfillPricesResponse
	51,  // 170: float.v1.LedgerService.ListAccountDeclarations:output_type -> float.v1.ListAccountDeclarationsResponse
	53,  // 171: float.v1.LedgerService.DeclareAccount:output_type -> float.v1.DeclareAccountResponse
	55,  // 172: float.v1.LedgerService.DeleteAccountDeclaration:output_type -> float.v1.DeleteAccountDeclarationResponse
	57,  // 173: float.v1.LedgerService.RenameAccount:output_type -> float.v1.RenameAccountResponse
	65,  // 174: float.v1.LedgerService.BulkEditTransactions:output_type -> float.v1.BulkEditTransactionsResponse
	68,  // 175: float.v1.LedgerService.ListSnapshots:output_type -> float.v1.ListSnapshotsResponse
	70,  // 176: float.v1.LedgerService.RestoreSnapshot:output_type -> float.v1.RestoreSnapshotResponse
	73,  // 177: float.v1.LedgerService.GetSnapshotDiff:output_type -> float.v1.GetSnapshotDiffResponse
	12,  // 178: float.v1.LedgerService.GetIncomeStatementTimeseries:output_type -> float.v1.GetIncomeStatementTimeseriesResponse
	76,  // 179: float.v1.LedgerService.ListBankProfiles:output_type -> float.v1.ListBankProfilesResponse
	78,  // 180: float.v1.LedgerService.CreateBankProfile:output_type -> float.v1.CreateBankProfileResponse
	80,  // 181: float.v1.LedgerService.GetBankProfileContent:output_type -> float.v1.GetBankProfileContentResponse
	82,  // 182: float.v1.LedgerService.UpdateBankProfile:output_type -> float.v1.UpdateBankProfileResponse
	84,  // 183: float.v1.LedgerService.DeleteBankProfile:output_type -> float.v1.DeleteBankProfileResponse
	87,  // 184: float.v1.LedgerService.PreviewImport:output_type -> float.v1.PreviewImportResponse
	91,  // 185: float.v1.LedgerService.ImportTransactions:output_type -> float.v1.ImportTransactionsResponse
	14,  // 186: float.v1.LedgerService.GetImportedTransactions:output_type -> float.v1.ListTransactionsResponse
	95,  // 187: float.v1.LedgerService.ListImports:output_type -> float.v1.ListImportsResponse
	97,  // 188: float.v1.LedgerService.GetImportFile:output_type -> float.v1.GetImportFileResponse
	100, // 189: float.v1.LedgerService.ListRules:output_type -> float.v1.ListRulesResponse
	103, // 190: float.v1.LedgerService.AddRule:output_type -> float.v1.AddRuleResponse
	105, // 191: float.v1.LedgerService.UpdateRule:output_type -> float.v1.UpdateRuleResponse
	107, // 192: float.v1.LedgerService.DeleteRule:output_type -> float.v1.DeleteRuleResponse
	110, // 193: float.v1.LedgerService.PreviewApplyRules:output_type -> float.v1.PreviewApplyRulesResponse
	112, // 194: float.v1.LedgerService.ApplyRules:output_type -> float.v1.ApplyRulesResponse
	121, // 195: float.v1.LedgerService.GetStripeConfig:output_type -> float.v1.GetStripeConfigResponse
	127, // 196: float.v1.LedgerService.CreateStripeLinkSession:output_type -> float.v1.CreateStripeLinkSessionResponse
	130, // 197: float.v1.LedgerService.CompleteStripeLinking:output_type -> float.v1.CompleteStripeLinkingResponse
	132, // 198: float.v1.LedgerService.ListStripeLinkedAccounts:output_type -> float.v1.ListStripeLinkedAccountsResponse
	134, // 199: float.v1.LedgerService.UnlinkStripeAccount:output_type -> float.v1.UnlinkStripeAccountResponse
	136, // 200: float.v1.LedgerService.FetchStripeTransactions:output_type -> float.v1.FetchStripeTransactionsResponse
	91,  // 201: float.v1.LedgerService.ImportStripeTransactions:output_type -> float.v1.ImportTransactionsResponse
	140, // 202: float.v1.LedgerService.FetchAllStripeTransactions:output_type -> float.v1.FetchAllStripeTransactionsResponse
	91,  // 203: float.v1.LedgerService.ImportAllStripeTransactions:output_type -> float.v1.ImportTransactionsResponse
	145, // 204: float.v1.LedgerService.SuggestRules:output_type -> float.v1.SuggestRulesResponse
	147, // 205: float.v1.LedgerService.TranslateQuery:output_type -> float.v1.TranslateQueryResponse
	149, // 206: float.v1.LedgerService.AskQuestion:output_type -> float.v1.AskQuestionResponse
	151, // 207: float.v1.LedgerService.GetAlphaVantageConfig:output_type -> float.v1.GetAlphaVantageConfigResponse
	153, // 208: float.v1.LedgerService.SetAlphaVantageApiKey:output_type -> float.v1.SetAlphaVantageApiKeyResponse
	155, // 209: float.v1.LedgerService.GetAIConfig:output_type -> float.v1.GetAIConfigResponse
	157, // 210: float.v1.LedgerService.SetAIModel:output_type -> float.v1.SetAIModelResponse
	159, // 211: float.v1.LedgerService.SetAIPrompt:output_type -> float.v1.SetAIPromptResponse
	125, // 212: float.v1.LedgerService.SetStripeCustomerId:output_type -> float.v1.SetStripeCustomerIdResponse
	123, // 213: float.v1.LedgerService.SetStripeDailyImportEnabled:output_type -> float.v1.SetStripeDailyImportEnabledResponse
	161, // 214: float.v1.LedgerService.RunHledgerQuery:output_type -> float.v1.RunHledgerQueryResponse
	151, // [151:215] is the sub-list for method output_type
	87,  // [87:151] is the sub-list for method input_type
