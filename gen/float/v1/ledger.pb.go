...
type ImportTransactionsResult struct {
	...
	SkippedDuplicateCount int32                  `protobuf:"varint,4,opt,name=skipped_duplicate_count,json=skippedDuplicateCount,proto3" json:"skipped_duplicate_count,omitempty"` // candidates skipped: fingerprint already on disk at write time
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ImportTransactionsResult) GetSkippedDuplicateCount() int32 {
	if x != nil {
		return x.SkippedDuplicateCount
	}
	return 0
}
...
// RuleIssueGroup flags two or more existing rules that are duplicates,
// contradict each other, or could be combined into a single rule.
type RuleIssueGroup struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IssueType     string                 `protobuf:"bytes,1,opt,name=issue_type,json=issueType,proto3" json:"issue_type,omitempty"` // "duplicate" | "contradiction" | "combinable"
	RuleIds       []string               `protobuf:"bytes,2,rep,name=rule_ids,json=ruleIds,proto3" json:"rule_ids,omitempty"`       // ids of the rules involved (at least 2)
	Explanation   string                 `protobuf:"bytes,3,opt,name=explanation,proto3" json:"explanation,omitempty"`              // brief explanation of the issue and suggested fix
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RuleIssueGroup) Reset() {
	*x = RuleIssueGroup{}
...
func (x *RuleIssueGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RuleIssueGroup) ProtoMessage() {}

func (x *RuleIssueGroup) ProtoReflect() protoreflect.Message {
	mi := &file_float_v1_ledger_proto_msgTypes[169]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RuleIssueGroup.ProtoReflect.Descriptor instead.
func (*RuleIssueGroup) Descriptor() ([]byte, []int) {
	return file_float_v1_ledger_proto_rawDescGZIP(), []int{169}
}

func (x *RuleIssueGroup) GetIssueType() string {
	if x != nil {
		return x.IssueType
	}
	return ""
...
func (x *RuleIssueGroup) GetRuleIds() []string {
	if x != nil {
		return x.RuleIds
	}
	return nil
...
func (x *RuleIssueGroup) GetExplanation() string {
	if x != nil {
...
type FindRuleIssuesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FindRuleIssuesRequest) Reset() {
	*x = FindRuleIssuesRequest{}
	mi := &file_float_v1_ledger_proto_msgTypes[170]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FindRuleIssuesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindRuleIssuesRequest) ProtoMessage() {}

func (x *FindRuleIssuesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_float_v1_ledger_proto_msgTypes[170]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindRuleIssuesRequest.ProtoReflect.Descriptor instead.
func (*FindRuleIssuesRequest) Descriptor() ([]byte, []int) {
	return file_float_v1_ledger_proto_rawDescGZIP(), []int{170}
}

type FindRuleIssuesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Issues        []*RuleIssueGroup      `protobuf:"bytes,1,rep,name=issues,proto3" json:"issues,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FindRuleIssuesResponse) Reset() {
	*x = FindRuleIssuesResponse{}
	mi := &file_float_v1_ledger_proto_msgTypes[171]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FindRuleIssuesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindRuleIssuesResponse) ProtoMessage() {}

func (x *FindRuleIssuesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_float_v1_ledger_proto_msgTypes[171]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindRuleIssuesResponse.ProtoReflect.Descriptor instead.
func (*FindRuleIssuesResponse) Descriptor() ([]byte, []int) {
	return file_float_v1_ledger_proto_rawDescGZIP(), []int{171}
}

func (x *FindRuleIssuesResponse) GetIssues() []*RuleIssueGroup {
	if x != nil {
		return x.Issues
	}
	return nil
...
type ExportJournalResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Content       []byte                 `protobuf:"bytes,1,opt,name=content,proto3" json:"content,omitempty"` // flattened journal text covering main.journal and all includes
	Filename      string                 `protobuf:"bytes,2,opt,name=filename,proto3" json:"filename,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExportJournalResponse) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *ExportJournalResponse) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
const file_float_v1_ledger_proto_rawDesc = "" +
	...
	"\x0fimport_batch_id\x18\x03 \x01(\tR\rimportBatchId\x126\n" +
	"\x17skipped_duplicate_count\x18\x04 \x01(\x05R\x15skippedDuplicateCount\"\x9d\x01\n" +
	...
	"\vsuggestions\x18\x01 \x03(\v2\x17.float.v1.SuggestedRuleR\vsuggestions\"l\n" +
	"\x0eRuleIssueGroup\x12\x1d\n" +
	"\n" +
	"issue_type\x18\x01 \x01(\tR\tissueType\x12\x19\n" +
	"\brule_ids\x18\x02 \x03(\tR\aruleIds\x12 \n" +
	"\vexplanation\x18\x03 \x01(\tR\vexplanation\"\x17\n" +
	"\x15FindRuleIssuesRequest\"J\n" +
	"\x16FindRuleIssuesResponse\x120\n" +
	"\x06issues\x18\x01 \x03(\v2\x18.float.v1.RuleIssueGroupR\x06issues\"3\n" +
	...
	"\fcommand_line\x18\x04 \x01(\tR\vcommandLine\"\x16\n" +
	"\x14ExportJournalRequest\"M\n" +
	"\x15ExportJournalResponse\x12\x18\n" +
	...
	"\x05entry\x18\x01 \x01(\v2\x12.float.v1.LogEntryR\x05entry2\xf39\n" +
	"\rLedgerService\x12Y\n" +
	...
	"\x0eFindRuleIssues\x12\x1f.float.v1.FindRuleIssuesRequest\x1a .float.v1.FindRuleIssuesResponse\x12S\n" +
	...
	"\x17UpdatePortfolioSettings\x12(.float.v1.UpdatePortfolioSettingsRequest\x1a).float.v1.UpdatePortfolioSettingsResponse\x12V\n" +
	"\x0fRunHledgerQuery\x12 .float.v1.RunHledgerQueryRequest\x1a!.float.v1.RunHledgerQueryResponse\x12I\n" +
	"\n" +
	"StreamLogs\x12\x1b.float.v1.StreamLogsRequest\x1a\x1c.float.v1.StreamLogsResponse0\x01\x12P\n" +
	"\rExportJournal\x12\x1e.float.v1.ExportJournalRequest\x1a\x1f.float.v1.ExportJournalResponseB0Z.github.com/brendanv/float/gen/float/v1;floatv1b\x06proto3"
...
var file_float_v1_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 219)
var file_float_v1_ledger_proto_goTypes = []any{
	...
	(*GeneratePricesFromCostRequest)(nil),        // 49: float.v1.GeneratePricesFromCostRequest
	(*GeneratePricesFromCostResponse)(nil),       // 50: float.v1.GeneratePricesFromCostResponse
	...
	(*RuleIssueGroup)(nil),                       // 169: float.v1.RuleIssueGroup
	(*FindRuleIssuesRequest)(nil),                // 170: float.v1.FindRuleIssuesRequest
	(*FindRuleIssuesResponse)(nil),               // 171: float.v1.FindRuleIssuesResponse
	(*TranslateQueryRequest)(nil),                // 172: float.v1.TranslateQueryRequest
	(*TranslateQueryResponse)(nil),               // 173: float.v1.TranslateQueryResponse
	(*AskQuestionRequest)(nil),                   // 174: float.v1.AskQuestionRequest
	(*AskQuestionResponse)(nil),                  // 175: float.v1.AskQuestionResponse
	(*GetAlphaVantageConfigRequest)(nil),         // 176: float.v1.GetAlphaVantageConfigRequest
	(*GetAlphaVantageConfigResponse)(nil),        // 177: float.v1.GetAlphaVantageConfigResponse
	(*SetAlphaVantageApiKeyRequest)(nil),         // 178: float.v1.SetAlphaVantageApiKeyRequest
	(*SetAlphaVantageApiKeyResponse)(nil),        // 179: float.v1.SetAlphaVantageApiKeyResponse
	(*GetAIConfigRequest)(nil),                   // 180: float.v1.GetAIConfigRequest
	(*GetAIConfigResponse)(nil),                  // 181: float.v1.GetAIConfigResponse
	(*SetAIModelRequest)(nil),                    // 182: float.v1.SetAIModelRequest
	(*SetAIModelResponse)(nil),                   // 183: float.v1.SetAIModelResponse
	(*SetAIPromptRequest)(nil),                   // 184: float.v1.SetAIPromptRequest
	(*SetAIPromptResponse)(nil),                  // 185: float.v1.SetAIPromptResponse
	(*GetGeneralConfigRequest)(nil),              // 186: float.v1.GetGeneralConfigRequest
	(*GetGeneralConfigResponse)(nil),             // 187: float.v1.GetGeneralConfigResponse
	(*SetTimezoneRequest)(nil),                   // 188: float.v1.SetTimezoneRequest
	(*SetTimezoneResponse)(nil),                  // 189: float.v1.SetTimezoneResponse
	(*GetPortfolioSettingsRequest)(nil),          // 190: float.v1.GetPortfolioSettingsRequest
	(*GetPortfolioSettingsResponse)(nil),         // 191: float.v1.GetPortfolioSettingsResponse
	(*UpdatePortfolioSettingsRequest)(nil),       // 192: float.v1.UpdatePortfolioSettingsRequest
	(*UpdatePortfolioSettingsResponse)(nil),      // 193: float.v1.UpdatePortfolioSettingsResponse
	(*RunHledgerQueryRequest)(nil),               // 194: float.v1.RunHledgerQueryRequest
	(*RunHledgerQueryResponse)(nil),              // 195: float.v1.RunHledgerQueryResponse
	(*ExportJournalRequest)(nil),                 // 196: float.v1.ExportJournalRequest
	(*ExportJournalResponse)(nil),                // 197: float.v1.ExportJournalResponse
	(*BalanceAssertion)(nil),                     // 198: float.v1.BalanceAssertion
	(*AccountAssertionStatus)(nil),               // 199: float.v1.AccountAssertionStatus
	(*GetBalanceAssertionStatusRequest)(nil),     // 200: float.v1.GetBalanceAssertionStatusRequest
	(*GetBalanceAssertionStatusResponse)(nil),    // 201: float.v1.GetBalanceAssertionStatusResponse
	(*LogEntry)(nil),                             // 202: float.v1.LogEntry
	(*StreamLogsRequest)(nil),                    // 203: float.v1.StreamLogsRequest
	(*StreamLogsResponse)(nil),                   // 204: float.v1.StreamLogsResponse
	nil,                                          // 205: float.v1.Transaction.TagsEntry
	nil,                                          // 206: float.v1.AccountRegisterRow.TagsEntry
	nil,                                          // 207: float.v1.ModifyTagsRequest.TagsEntry
	nil,                                          // 208: float.v1.AddTransactionRequest.TagsEntry
	nil,                                          // 209: float.v1.UpdateTransactionRequest.TagsEntry
	nil,                                          // 210: float.v1.TransactionRule.TagsEntry
	nil,                                          // 211: float.v1.RuleInput.TagsEntry
	nil,                                          // 212: float.v1.UpdateRuleRequest.TagsEntry
	nil,                                          // 213: float.v1.TransactionTemplate.TagsEntry
	nil,                                          // 214: float.v1.AddTemplateRequest.TagsEntry
	nil,                                          // 215: float.v1.UpdateTemplateRequest.TagsEntry
	nil,                                          // 216: float.v1.RuleApplicationPreview.AddTagsEntry
	nil,                                          // 217: float.v1.SuggestedRule.TagsEntry
	nil,                                          // 218: float.v1.LogEntry.AttrsEntry
}
var file_float_v1_ledger_proto_depIdxs = []int32{
	...
	198, // 2: float.v1.Posting.balance_assertion:type_name -> float.v1.BalanceAssertion
	1,   // 3: float.v1.Transaction.postings:type_name -> float.v1.Posting
	205, // 4: float.v1.Transaction.tags:type_name -> float.v1.Transaction.TagsEntry
	...
	206, // 21: float.v1.AccountRegisterRow.tags:type_name -> float.v1.AccountRegisterRow.TagsEntry
	...
	207, // 24: float.v1.ModifyTagsRequest.tags:type_name -> float.v1.ModifyTagsRequest.TagsEntry
	...
	198, // 27: float.v1.PostingInput.balance_assertion:type_name -> float.v1.BalanceAssertion
	33,  // 28: float.v1.AddTransactionRequest.postings:type_name -> float.v1.PostingInput
	208, // 29: float.v1.AddTransactionRequest.tags:type_name -> float.v1.AddTransactionRequest.TagsEntry
	...
	209, // 32: float.v1.UpdateTransactionRequest.tags:type_name -> float.v1.UpdateTransactionRequest.TagsEntry
	...
	40,  // 39: float.v1.GeneratePricesFromCostResponse.added_prices:type_name -> float.v1.PriceDirective
	51,  // 40: float.v1.ListAccountDeclarationsResponse.declarations:type_name -> float.v1.AccountDeclaration
	51,  // 41: float.v1.DeclareAccountResponse.declaration:type_name -> float.v1.AccountDeclaration
	60,  // 42: float.v1.BulkEditOperation.mark_reviewed:type_name -> float.v1.MarkReviewedOperation
	61,  // 43: float.v1.BulkEditOperation.add_tag:type_name -> float.v1.AddTagOperation
	62,  // 44: float.v1.BulkEditOperation.remove_tag:type_name -> float.v1.RemoveTagOperation
	63,  // 45: float.v1.BulkEditOperation.set_payee:type_name -> float.v1.SetPayeeOperation
	64,  // 46: float.v1.BulkEditOperation.clear_payee:type_name -> float.v1.ClearPayeeOperation
	65,  // 47: float.v1.BulkEditOperation.delete:type_name -> float.v1.DeleteOperation
	66,  // 48: float.v1.BulkEditOperation.update_unknown_account:type_name -> float.v1.UpdateUnknownAccountOperation
	67,  // 49: float.v1.BulkEditTransactionsRequest.operations:type_name -> float.v1.BulkEditOperation
	2,   // 50: float.v1.BulkEditTransactionsResponse.transactions:type_name -> float.v1.Transaction
	71,  // 51: float.v1.BulkDeleteTransactionsResponse.progress:type_name -> float.v1.BulkDeleteTransactionsProgress
	72,  // 52: float.v1.BulkDeleteTransactionsResponse.result:type_name -> float.v1.BulkDeleteTransactionsResult
	74,  // 53: float.v1.ListSnapshotsResponse.snapshots:type_name -> float.v1.Snapshot
	79,  // 54: float.v1.GetSnapshotDiffResponse.files:type_name -> float.v1.FileDiff
	82,  // 55: float.v1.ListBankProfilesResponse.profiles:type_name -> float.v1.BankProfile
	82,  // 56: float.v1.CreateBankProfileResponse.profile:type_name -> float.v1.BankProfile
	82,  // 57: float.v1.UpdateBankProfileResponse.profile:type_name -> float.v1.BankProfile
	2,   // 58: float.v1.ImportCandidate.transaction:type_name -> float.v1.Transaction
	94,  // 59: float.v1.PreviewImportResponse.candidates:type_name -> float.v1.ImportCandidate
	2,   // 60: float.v1.ImportTransactionsResult.transactions:type_name -> float.v1.Transaction
	97,  // 61: float.v1.ImportTransactionsResponse.progress:type_name -> float.v1.ImportProgress
	98,  // 62: float.v1.ImportTransactionsResponse.result:type_name -> float.v1.ImportTransactionsResult
	101, // 63: float.v1.ListImportsResponse.imports:type_name -> float.v1.ImportSummary
	210, // 64: float.v1.TransactionRule.tags:type_name -> float.v1.TransactionRule.TagsEntry
	106, // 65: float.v1.ListRulesResponse.rules:type_name -> float.v1.TransactionRule
	211, // 66: float.v1.RuleInput.tags:type_name -> float.v1.RuleInput.TagsEntry
	109, // 67: float.v1.AddRuleRequest.rules:type_name -> float.v1.RuleInput
	106, // 68: float.v1.AddRuleResponse.rules:type_name -> float.v1.TransactionRule
	212, // 69: float.v1.UpdateRuleRequest.tags:type_name -> float.v1.UpdateRuleRequest.TagsEntry
	106, // 70: float.v1.UpdateRuleResponse.rule:type_name -> float.v1.TransactionRule
	117, // 71: float.v1.TransactionTemplate.postings:type_name -> float.v1.TemplatePosting
	213, // 72: float.v1.TransactionTemplate.tags:type_name -> float.v1.TransactionTemplate.TagsEntry
	116, // 73: float.v1.ListTemplatesResponse.templates:type_name -> float.v1.TransactionTemplate
	117, // 74: float.v1.AddTemplateRequest.postings:type_name -> float.v1.TemplatePosting
	214, // 75: float.v1.AddTemplateRequest.tags:type_name -> float.v1.AddTemplateRequest.TagsEntry
	117, // 76: float.v1.UpdateTemplateRequest.postings:type_name -> float.v1.TemplatePosting
	215, // 77: float.v1.UpdateTemplateRequest.tags:type_name -> float.v1.UpdateTemplateRequest.TagsEntry
	216, // 78: float.v1.RuleApplicationPreview.add_tags:type_name -> float.v1.RuleApplicationPreview.AddTagsEntry
	125, // 79: float.v1.PreviewApplyRulesResponse.previews:type_name -> float.v1.RuleApplicationPreview
	128, // 80: float.v1.ApplyRulesResponse.progress:type_name -> float.v1.ApplyRulesProgress
	129, // 81: float.v1.ApplyRulesResponse.result:type_name -> float.v1.ApplyRulesResult
	...
	131, // 86: float.v1.GetPortfolioHoldingsResponse.holdings:type_name -> float.v1.Holding
	0,   // 87: float.v1.GetPortfolioHoldingsResponse.total_value:type_name -> float.v1.Amount
	0,   // 88: float.v1.GetPortfolioHoldingsResponse.currency_totals:type_name -> float.v1.Amount
	...
	217, // 102: float.v1.SuggestedRule.tags:type_name -> float.v1.SuggestedRule.TagsEntry
	166, // 103: float.v1.SuggestRulesResponse.suggestions:type_name -> float.v1.SuggestedRule
	169, // 104: float.v1.FindRuleIssuesResponse.issues:type_name -> float.v1.RuleIssueGroup
	...
	199, // 108: float.v1.GetBalanceAssertionStatusResponse.accounts:type_name -> float.v1.AccountAssertionStatus
	218, // 109: float.v1.LogEntry.attrs:type_name -> float.v1.LogEntry.AttrsEntry
	202, // 110: float.v1.StreamLogsResponse.entry:type_name -> float.v1.LogEntry
	...
	200, // 115: float.v1.LedgerService.GetBalanceAssertionStatus:input_type -> float.v1.GetBalanceAssertionStatusRequest
	...
	36,  // 121: float.v1.LedgerService.UpdateTransaction:input_type -> float.v1.UpdateTransactionRequest
	34,  // 122: float.v1.LedgerService.AddTransaction:input_type -> float.v1.AddTransactionRequest
	38,  // 123: float.v1.LedgerService.UpdateTransactionStatus:input_type -> float.v1.UpdateTransactionStatusRequest
	...
	41,  // 127: float.v1.LedgerService.ListPrices:input_type -> float.v1.ListPricesRequest
	43,  // 128: float.v1.LedgerService.AddPrice:input_type -> float.v1.AddPriceRequest
	45,  // 129: float.v1.LedgerService.DeletePrice:input_type -> float.v1.DeletePriceRequest
	47,  // 130: float.v1.LedgerService.BackfillPrices:input_type -> float.v1.BackfillPricesRequest
	49,  // 131: float.v1.LedgerService.GeneratePricesFromCost:input_type -> float.v1.GeneratePricesFromCostRequest
	52,  // 132: float.v1.LedgerService.ListAccountDeclarations:input_type -> float.v1.ListAccountDeclarationsRequest
	54,  // 133: float.v1.LedgerService.DeclareAccount:input_type -> float.v1.DeclareAccountRequest
	56,  // 134: float.v1.LedgerService.DeleteAccountDeclaration:input_type -> float.v1.DeleteAccountDeclarationRequest
	58,  // 135: float.v1.LedgerService.RenameAccount:input_type -> float.v1.RenameAccountRequest
	68,  // 136: float.v1.LedgerService.BulkEditTransactions:input_type -> float.v1.BulkEditTransactionsRequest
	70,  // 137: float.v1.LedgerService.BulkDeleteTransactions:input_type -> float.v1.BulkDeleteTransactionsRequest
	75,  // 138: float.v1.LedgerService.ListSnapshots:input_type -> float.v1.ListSnapshotsRequest
	77,  // 139: float.v1.LedgerService.RestoreSnapshot:input_type -> float.v1.RestoreSnapshotRequest
	80,  // 140: float.v1.LedgerService.GetSnapshotDiff:input_type -> float.v1.GetSnapshotDiffRequest
	11,  // 141: float.v1.LedgerService.GetIncomeStatementTimeseries:input_type -> float.v1.GetIncomeStatementTimeseriesRequest
	83,  // 142: float.v1.LedgerService.ListBankProfiles:input_type -> float.v1.ListBankProfilesRequest
	85,  // 143: float.v1.LedgerService.CreateBankProfile:input_type -> float.v1.CreateBankProfileRequest
	87,  // 144: float.v1.LedgerService.GetBankProfileContent:input_type -> float.v1.GetBankProfileContentRequest
	89,  // 145: float.v1.LedgerService.UpdateBankProfile:input_type -> float.v1.UpdateBankProfileRequest
	91,  // 146: float.v1.LedgerService.DeleteBankProfile:input_type -> float.v1.DeleteBankProfileRequest
	93,  // 147: float.v1.LedgerService.PreviewImport:input_type -> float.v1.PreviewImportRequest
	96,  // 148: float.v1.LedgerService.ImportTransactions:input_type -> float.v1.ImportTransactionsRequest
	100, // 149: float.v1.LedgerService.GetImportedTransactions:input_type -> float.v1.GetImportedTransactionsRequest
	102, // 150: float.v1.LedgerService.ListImports:input_type -> float.v1.ListImportsRequest
	104, // 151: float.v1.LedgerService.GetImportFile:input_type -> float.v1.GetImportFileRequest
	107, // 152: float.v1.LedgerService.ListRules:input_type -> float.v1.ListRulesRequest
	110, // 153: float.v1.LedgerService.AddRule:input_type -> float.v1.AddRuleRequest
	112, // 154: float.v1.LedgerService.UpdateRule:input_type -> float.v1.UpdateRuleRequest
	114, // 155: float.v1.LedgerService.DeleteRule:input_type -> float.v1.DeleteRuleRequest
	124, // 156: float.v1.LedgerService.PreviewApplyRules:input_type -> float.v1.PreviewApplyRulesRequest
	127, // 157: float.v1.LedgerService.ApplyRules:input_type -> float.v1.ApplyRulesRequest
	118, // 158: float.v1.LedgerService.ListTemplates:input_type -> float.v1.ListTemplatesRequest
	120, // 159: float.v1.LedgerService.AddTemplate:input_type -> float.v1.AddTemplateRequest
	121, // 160: float.v1.LedgerService.UpdateTemplate:input_type -> float.v1.UpdateTemplateRequest
	122, // 161: float.v1.LedgerService.DeleteTemplate:input_type -> float.v1.DeleteTemplateRequest
	138, // 162: float.v1.LedgerService.GetStripeConfig:input_type -> float.v1.GetStripeConfigRequest
	144, // 163: float.v1.LedgerService.CreateStripeLinkSession:input_type -> float.v1.CreateStripeLinkSessionRequest
	147, // 164: float.v1.LedgerService.CompleteStripeLinking:input_type -> float.v1.CompleteStripeLinkingRequest
	149, // 165: float.v1.LedgerService.ListStripeLinkedAccounts:input_type -> float.v1.ListStripeLinkedAccountsRequest
	151, // 166: float.v1.LedgerService.UnlinkStripeAccount:input_type -> float.v1.UnlinkStripeAccountRequest
	153, // 167: float.v1.LedgerService.FetchStripeTransactions:input_type -> float.v1.FetchStripeTransactionsRequest
	155, // 168: float.v1.LedgerService.ImportStripeTransactions:input_type -> float.v1.ImportStripeTransactionsRequest
	157, // 169: float.v1.LedgerService.FetchAllStripeTransactions:input_type -> float.v1.FetchAllStripeTransactionsRequest
	160, // 170: float.v1.LedgerService.ImportAllStripeTransactions:input_type -> float.v1.ImportAllStripeTransactionsRequest
	161, // 171: float.v1.LedgerService.RefreshStripeAccount:input_type -> float.v1.RefreshStripeAccountRequest
	162, // 172: float.v1.LedgerService.RefreshAllStripeAccounts:input_type -> float.v1.RefreshAllStripeAccountsRequest
	167, // 173: float.v1.LedgerService.SuggestRules:input_type -> float.v1.SuggestRulesRequest
	170, // 174: float.v1.LedgerService.FindRuleIssues:input_type -> float.v1.FindRuleIssuesRequest
	172, // 175: float.v1.LedgerService.TranslateQuery:input_type -> float.v1.TranslateQueryRequest
	174, // 176: float.v1.LedgerService.AskQuestion:input_type -> float.v1.AskQuestionRequest
	176, // 177: float.v1.LedgerService.GetAlphaVantageConfig:input_type -> float.v1.GetAlphaVantageConfigRequest
	178, // 178: float.v1.LedgerService.SetAlphaVantageApiKey:input_type -> float.v1.SetAlphaVantageApiKeyRequest
	180, // 179: float.v1.LedgerService.GetAIConfig:input_type -> float.v1.GetAIConfigRequest
	182, // 180: float.v1.LedgerService.SetAIModel:input_type -> float.v1.SetAIModelRequest
	184, // 181: float.v1.LedgerService.SetAIPrompt:input_type -> float.v1.SetAIPromptRequest
	142, // 182: float.v1.LedgerService.SetStripeCustomerId:input_type -> float.v1.SetStripeCustomerIdRequest
	140, // 183: float.v1.LedgerService.SetStripeDailyImportEnabled:input_type -> float.v1.SetStripeDailyImportEnabledRequest
	186, // 184: float.v1.LedgerService.GetGeneralConfig:input_type -> float.v1.GetGeneralConfigRequest
	188, // 185: float.v1.LedgerService.SetTimezone:input_type -> float.v1.SetTimezoneRequest
	190, // 186: float.v1.LedgerService.GetPortfolioSettings:input_type -> float.v1.GetPortfolioSettingsRequest
	192, // 187: float.v1.LedgerService.UpdatePortfolioSettings:input_type -> float.v1.UpdatePortfolioSettingsRequest
	194, // 188: float.v1.LedgerService.RunHledgerQuery:input_type -> float.v1.RunHledgerQueryRequest
	203, // 189: float.v1.LedgerService.StreamLogs:input_type -> float.v1.StreamLogsRequest
	196, // 190: float.v1.LedgerService.ExportJournal:input_type -> float.v1.ExportJournalRequest
	14,  // 191: float.v1.LedgerService.ListTransactions:output_type -> float.v1.ListTransactionsResponse
	19,  // 192: float.v1.LedgerService.GetAccountRegister:output_type -> float.v1.GetAccountRegisterResponse
	16,  // 193: float.v1.LedgerService.GetBalances:output_type -> float.v1.GetBalancesResponse
	21,  // 194: float.v1.LedgerService.ListAccounts:output_type -> float.v1.ListAccountsResponse
	201, // 195: float.v1.LedgerService.GetBalanceAssertionStatus:output_type -> float.v1.GetBalanceAssertionStatusResponse
	23,  // 196: float.v1.LedgerService.ListTags:output_type -> float.v1.ListTagsResponse
	25,  // 197: float.v1.LedgerService.ListPayees:output_type -> float.v1.ListPayeesResponse
	27,  // 198: float.v1.LedgerService.DeleteTransaction:output_type -> float.v1.DeleteTransactionResponse
	29,  // 199: float.v1.LedgerService.ModifyTags:output_type -> float.v1.ModifyTagsResponse
	31,  // 200: float.v1.LedgerService.UpdateTransactionDate:output_type -> float.v1.UpdateTransactionDateResponse
	37,  // 201: float.v1.LedgerService.UpdateTransaction:output_type -> float.v1.UpdateTransactionResponse
	35,  // 202: float.v1.LedgerService.AddTransaction:output_type -> float.v1.AddTransactionResponse
	39,  // 203: float.v1.LedgerService.UpdateTransactionStatus:output_type -> float.v1.UpdateTransactionStatusResponse
	8,   // 204: float.v1.LedgerService.GetNetWorthTimeseries:output_type -> float.v1.GetNetWorthTimeseriesResponse
	133, // 205: float.v1.LedgerService.GetPortfolioHoldings:output_type -> float.v1.GetPortfolioHoldingsResponse
	136, // 206: float.v1.LedgerService.GetPortfolioTimeseries:output_type -> float.v1.GetPortfolioTimeseriesResponse
	42,  // 207: float.v1.LedgerService.ListPrices:output_type -> float.v1.ListPricesResponse
	44,  // 208: float.v1.LedgerService.AddPrice:output_type -> float.v1.AddPriceResponse
	46,  // 209: float.v1.LedgerService.DeletePrice:output_type -> float.v1.DeletePriceResponse
	48,  // 210: float.v1.LedgerService.BackfillPrices:output_type -> float.v1.BackfillPricesResponse
	50,  // 211: float.v1.LedgerService.GeneratePricesFromCost:output_type -> float.v1.GeneratePricesFromCostResponse
	53,  // 212: float.v1.LedgerService.ListAccountDeclarations:output_type -> float.v1.ListAccountDeclarationsResponse
	55,  // 213: float.v1.LedgerService.DeclareAccount:output_type -> float.v1.DeclareAccountResponse
	57,  // 214: float.v1.LedgerService.DeleteAccountDeclaration:output_type -> float.v1.DeleteAccountDeclarationResponse
	59,  // 215: float.v1.LedgerService.RenameAccount:output_type -> float.v1.RenameAccountResponse
	69,  // 216: float.v1.LedgerService.BulkEditTransactions:output_type -> float.v1.BulkEditTransactionsResponse
	73,  // 217: float.v1.LedgerService.BulkDeleteTransactions:output_type -> float.v1.BulkDeleteTransactionsResponse
	76,  // 218: float.v1.LedgerService.ListSnapshots:output_type -> float.v1.ListSnapshotsResponse
	78,  // 219: float.v1.LedgerService.RestoreSnapshot:output_type -> float.v1.RestoreSnapshotResponse
	81,  // 220: float.v1.LedgerService.GetSnapshotDiff:output_type -> float.v1.GetSnapshotDiffResponse
	12,  // 221: float.v1.LedgerService.GetIncomeStatementTimeseries:output_type -> float.v1.GetIncomeStatementTimeseriesResponse
	84,  // 222: float.v1.LedgerService.ListBankProfiles:output_type -> float.v1.ListBankProfilesResponse
	86,  // 223: float.v1.LedgerService.CreateBankProfile:output_type -> float.v1.CreateBankProfileResponse
	88,  // 224: float.v1.LedgerService.GetBankProfileContent:output_type -> float.v1.GetBankProfileContentResponse
	90,  // 225: float.v1.LedgerService.UpdateBankProfile:output_type -> float.v1.UpdateBankProfileResponse
	92,  // 226: float.v1.LedgerService.DeleteBankProfile:output_type -> float.v1.DeleteBankProfileResponse
	95,  // 227: float.v1.LedgerService.PreviewImport:output_type -> float.v1.PreviewImportResponse
	99,  // 228: float.v1.LedgerService.ImportTransactions:output_type -> float.v1.ImportTransactionsResponse
	14,  // 229: float.v1.LedgerService.GetImportedTransactions:output_type -> float.v1.ListTransactionsResponse
	103, // 230: float.v1.LedgerService.ListImports:output_type -> float.v1.ListImportsResponse
	105, // 231: float.v1.LedgerService.GetImportFile:output_type -> float.v1.GetImportFileResponse
	108, // 232: float.v1.LedgerService.ListRules:output_type -> float.v1.ListRulesResponse
	111, // 233: float.v1.LedgerService.AddRule:output_type -> float.v1.AddRuleResponse
	113, // 234: float.v1.LedgerService.UpdateRule:output_type -> float.v1.UpdateRuleResponse
	115, // 235: float.v1.LedgerService.DeleteRule:output_type -> float.v1.DeleteRuleResponse
	126, // 236: float.v1.LedgerService.PreviewApplyRules:output_type -> float.v1.PreviewApplyRulesResponse
	130, // 237: float.v1.LedgerService.ApplyRules:output_type -> float.v1.ApplyRulesResponse
	119, // 238: float.v1.LedgerService.ListTemplates:output_type -> float.v1.ListTemplatesResponse
	116, // 239: float.v1.LedgerService.AddTemplate:output_type -> float.v1.TransactionTemplate
	116, // 240: float.v1.LedgerService.UpdateTemplate:output_type -> float.v1.TransactionTemplate
	123, // 241: float.v1.LedgerService.DeleteTemplate:output_type -> float.v1.DeleteTemplateResponse
	139, // 242: float.v1.LedgerService.GetStripeConfig:output_type -> float.v1.GetStripeConfigResponse
	145, // 243: float.v1.LedgerService.CreateStripeLinkSession:output_type -> float.v1.CreateStripeLinkSessionResponse
	148, // 244: float.v1.LedgerService.CompleteStripeLinking:output_type -> float.v1.CompleteStripeLinkingResponse
	150, // 245: float.v1.LedgerService.ListStripeLinkedAccounts:output_type -> float.v1.ListStripeLinkedAccountsResponse
	152, // 246: float.v1.LedgerService.UnlinkStripeAccount:output_type -> float.v1.UnlinkStripeAccountResponse
	154, // 247: float.v1.LedgerService.FetchStripeTransactions:output_type -> float.v1.FetchStripeTransactionsResponse
	99,  // 248: float.v1.LedgerService.ImportStripeTransactions:output_type -> float.v1.ImportTransactionsResponse
	158, // 249: float.v1.LedgerService.FetchAllStripeTransactions:output_type -> float.v1.FetchAllStripeTransactionsResponse
	99,  // 250: float.v1.LedgerService.ImportAllStripeTransactions:output_type -> float.v1.ImportTransactionsResponse
	165, // 251: float.v1.LedgerService.RefreshStripeAccount:output_type -> float.v1.RefreshStripeAccountResponse
	165, // 252: float.v1.LedgerService.RefreshAllStripeAccounts:output_type -> float.v1.RefreshStripeAccountResponse
	168, // 253: float.v1.LedgerService.SuggestRules:output_type -> float.v1.SuggestRulesResponse
	171, // 254: float.v1.LedgerService.FindRuleIssues:output_type -> float.v1.FindRuleIssuesResponse
	173, // 255: float.v1.LedgerService.TranslateQuery:output_type -> float.v1.TranslateQueryResponse
	175, // 256: float.v1.LedgerService.AskQuestion:output_type -> float.v1.AskQuestionResponse
	177, // 257: float.v1.LedgerService.GetAlphaVantageConfig:output_type -> float.v1.GetAlphaVantageConfigResponse
	179, // 258: float.v1.LedgerService.SetAlphaVantageApiKey:output_type -> float.v1.SetAlphaVantageApiKeyResponse
	181, // 259: float.v1.LedgerService.GetAIConfig:output_type -> float.v1.GetAIConfigResponse
	183, // 260: float.v1.LedgerService.SetAIModel:output_type -> float.v1.SetAIModelResponse
	185, // 261: float.v1.LedgerService.SetAIPrompt:output_type -> float.v1.SetAIPromptResponse
	143, // 262: float.v1.LedgerService.SetStripeCustomerId:output_type -> float.v1.SetStripeCustomerIdResponse
	141, // 263: float.v1.LedgerService.SetStripeDailyImportEnabled:output_type -> float.v1.SetStripeDailyImportEnabledResponse
	187, // 264: float.v1.LedgerService.GetGeneralConfig:output_type -> float.v1.GetGeneralConfigResponse
	189, // 265: float.v1.LedgerService.SetTimezone:output_type -> float.v1.SetTimezoneResponse
	191, // 266: float.v1.LedgerService.GetPortfolioSettings:output_type -> float.v1.GetPortfolioSettingsResponse
	193, // 267: float.v1.LedgerService.UpdatePortfolioSettings:output_type -> float.v1.UpdatePortfolioSettingsResponse
	195, // 268: float.v1.LedgerService.RunHledgerQuery:output_type -> float.v1.RunHledgerQueryResponse
	204, // 269: float.v1.LedgerService.StreamLogs:output_type -> float.v1.StreamLogsResponse
	197, // 270: float.v1.LedgerService.ExportJournal:output_type -> float.v1.ExportJournalResponse
	191, // [191:271] is the sub-list for method output_type
	111, // [111:191] is the sub-list for method input_type
...
func file_float_v1_ledger_proto_init() {
	...
	file_float_v1_ledger_proto_msgTypes[89].OneofWrappers = []any{}
	...
	file_float_v1_ledger_proto_msgTypes[199].OneofWrappers = []any{}
	type x struct{}
