  ...
  await page.route("**/float.v1.LedgerService/**", async (route) => {
    ...
    switch (method) {
      ...
      case "GetAlphaVantageConfig":
        ...
        break;
      case "GetAIConfig":
        body = { model: "anthropic/claude-sonnet-4-6", effectiveModel: "anthropic/claude-sonnet-4-6", prompt: "My accounts use kebab-case. Groceries go under expenses:food:groceries.", enabled: true };
        break;
      case "ListSnapshots":
