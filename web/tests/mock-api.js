...
export const mockTransactions = [
  {
    ...
    postings: [
      { account: "expenses:groceries", amount: { commodity: "USD", quantity: "87.43" } },
      { account: "liabilities:creditcard", amount: { commodity: "USD", quantity: "-87.43" } },
    ],
    tags: [],
  },
  {
    ...
    postings: [
      { account: "assets:checking", amount: { commodity: "USD", quantity: "5200.00" } },
      { account: "income:salary", amount: { commodity: "USD", quantity: "-5200.00" } },
    ],
    tags: [],
  },
  {
    ...
    postings: [
      { account: "expenses:dining", amount: { commodity: "USD", quantity: "14.75" } },
      { account: "liabilities:creditcard", amount: { commodity: "USD", quantity: "-14.75" } },
    ],
    tags: [],
  },
  {
    ...
    postings: [
      { account: "expenses:utilities", amount: { commodity: "USD", quantity: "95.00" } },
      { account: "assets:checking", amount: { commodity: "USD", quantity: "-95.00" } },
    ],
    tags: [],
  },
  {
    ...
    postings: [
      { account: "expenses:groceries", amount: { commodity: "USD", quantity: "62.18" } },
      { account: "liabilities:creditcard", amount: { commodity: "USD", quantity: "-62.18" } },
    ],
    tags: [],
  },
];
